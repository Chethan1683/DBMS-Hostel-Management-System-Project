...
if(!$con)
{
    ...
    font-weight: 900;'>ROOM DETAILS</h3>
        <ul align='right'>
        <a href='adminmain.php' style='text-decoration: none;'><img src='image/left-arrow.png' alt='BACK' title='BACK' style='width: 50px;height: 50px;'><b>BACK</b></a>
        <a href='adminmain.php' style='text-decoration: none;'><img src='image/home.png' title='HOME' alt='HOME'  style='width: 50px;height: 50px;margin-left:50px;'><b>HOME</b></a>
        ...
        <center><form action='roomdetails.php' method='post' class='fee'>
